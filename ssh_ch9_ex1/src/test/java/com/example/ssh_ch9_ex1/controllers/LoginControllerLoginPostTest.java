package com.example.ssh_ch9_ex1.controllers;


import com.example.ssh_ch9_ex1.processors.LoginProcessor;
...
class LoginControllerLoginPostTest {
    ...
    @DisplayName("""
            ...
            THEN it should return status 200, the login.html view, and success message
            """)
    void testLoginPostSuccess() throws Exception {
        ...
        mockMvc.perform(post("/")
                ...
                .andExpect(model().attribute("message", "You are now logged in."));
